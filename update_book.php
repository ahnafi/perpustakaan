...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($author) || empty($publisher) || $year == 0 || $category_id == 0) {
        ...
        $cover = $book['cover']; // Keep existing cover
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p class="page-subtitle">Perbarui informasi buku</p>
            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <div class="border rounded p-4 text-center" style="min-height: 200px;">
                                        ...
                                        <small class="text-muted mt-2 d-block">Kosongkan jika tidak ingin mengubah</small>
                                    </div>
                                </div>
                            </div>
                        </div>
